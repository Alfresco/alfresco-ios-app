...
// Accounts
extern NSString * const kAlfrescoSelectedAccount;
extern NSString * const kAlfrescoSelectedAccountSession;
...
extern NSString * const kAlfrescoSelectedAccountChangedNotification;
