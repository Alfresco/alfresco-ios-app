...
@property (nonatomic, strong) NSMutableArray *allSectionItems;
@property (nonatomic, strong) NSMutableArray *visibleSectionItems;
@property (nonatomic, strong) NSMutableArray *hiddenSectionItems;
