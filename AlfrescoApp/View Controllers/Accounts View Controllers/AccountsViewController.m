...
- (void)registerForNotifications
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(mainMenuConfigurationChanged:) name:kAlfrescoConfigurationFileDidUpdateNotification object:nil];
}
