...
@implementation AccountCloudSettingsDataSource
...
- (void)setupTableViewData
{
    ...
    self.tableViewData = @[@[descriptionCell]];
}

- (void)setupHeaders
{
    self.tableGroupHeaders = @[@"accountdetails.header.authentication"];
}
...
- (BOOL)validateAccountFieldsValues
{
    ...
    AccountFormFieldValidation validation = [self validateDescription];
