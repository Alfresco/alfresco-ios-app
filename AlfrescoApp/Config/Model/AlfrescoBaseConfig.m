...
- (id)initWithDictionary:(NSDictionary *)properties
{
    ...
    if (nil != self)
    {
        self.identifier = [properties objectForKeyNotNSNull:kAlfrescoBaseConfigPropertyIdentifier];
        self.label = [properties objectForKeyNotNSNull:kAlfrescoBaseConfigPropertyLabel];
        self.summary = [properties objectForKeyNotNSNull:kAlfrescoBaseConfigPropertySummary];
    }
    return self;
}
